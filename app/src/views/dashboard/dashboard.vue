  ...
  <div class="pa-6 d-flex flex-column align-center text-center">
    <div class="mb-6">
      <div class="text-center mb-10">
        ...
        <p class="text-subtitle-1" style="color: rgba(255, 255, 255, 0.7); max-width: 700px; margin: 0 auto;">
          Veja as denúncias mais recentes da comunidade sobre empresas suspeitas
        </p>
      </div>
